---
title: Motion Planner for Public Roads and Airport Aprons
summary: Static-obstacle avoidance, parked-car overtaking, and emergency collision avoidance.
tags:
  - Autonomous Driving
...
![alt](shift.gif)
[Watch Full Video](https://www.youtube.com/watch?v=0tRZIa5q0tU)
### Introduction
...
- Using this algorithm, the system determines whether overtaking is necessary for obstacle avoidance.
...
- The Emergency Collision Avoidance (ECA) module is an independent safety mechanism designed to operate when primary autonomous driving modules malfunction or behave abnormally.
